...
for (let i = 0; i < lettersToPair.length; i++) {
    for (let k = i + 1; k < lettersToPair.length; k++) {
        if (lettersToPair[i] === lettersToPair[k]) {
            pairsArray.push([i, k])
        }
    }
}
...
//CODE HERE
let phone1 = new Phone('1', 'Google Pixel', 64, 'black', false)

let phone2 = new Phone('2', 'Google Pixel', 32, 'white', false)

let phone3 = new Phone('3', 'Google Pixel', 16, 'grey', false)
